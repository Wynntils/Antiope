...
#include "com_wynntils_antiope_CreateParams.h"
#include "EventHandler.h"

JNIEXPORT jlong JNICALL Java_com_wynntils_antiope_CreateParams_allocate(JNIEnv *env, jobject object)
{
...
JNIEXPORT void JNICALL Java_com_wynntils_antiope_CreateParams_free(JNIEnv *env, jobject object, jlong pointer)
{
...
JNIEXPORT void JNICALL Java_com_wynntils_antiope_CreateParams_setClientID(JNIEnv *env, jobject object, jlong pointer, jlong client_id)
{
	struct DiscordCreateParams *params = (struct DiscordCreateParams*) pointer;
	params->client_id = client_id;
}

JNIEXPORT jlong JNICALL Java_com_wynntils_antiope_CreateParams_getClientID(JNIEnv *env, jobject object, jlong pointer)
{
	struct DiscordCreateParams *params = (struct DiscordCreateParams*) pointer;
	return params->client_id;
}

JNIEXPORT void JNICALL Java_com_wynntils_antiope_CreateParams_setFlags(JNIEnv *env, jobject object, jlong pointer, jlong flags)
{
	struct DiscordCreateParams *params = (struct DiscordCreateParams*) pointer;
	params->flags = flags;
}

JNIEXPORT jlong JNICALL Java_com_wynntils_antiope_CreateParams_getFlags(JNIEnv *env, jobject object, jlong pointer)
{
	struct DiscordCreateParams *params = (struct DiscordCreateParams*) pointer;
	return params->flags;
}

JNIEXPORT void JNICALL Java_com_wynntils_antiope_CreateParams_registerEventHandler(JNIEnv *env, jobject object, jlong pointer, jobject handler)
{
	struct DiscordCreateParams *params = (struct DiscordCreateParams*) pointer;
...
JNIEXPORT jlong JNICALL Java_com_wynntils_antiope_CreateParams_getDefaultFlags(JNIEnv *env, jclass clazz)
{
