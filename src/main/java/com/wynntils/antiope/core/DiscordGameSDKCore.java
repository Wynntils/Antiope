...
public class DiscordGameSDKCore implements AutoCloseable {
    ...
    public static void loadLibrary() {
        ...
        if (osName.contains("windows")) {
            osName = "windows";
            jniLibraryName = JNI_LIBRARY_NAME + ".dll";
            discordSdkName = DISCORD_LIBRARY_NAME + ".dll";

            // Discord Game SDK needs to be loaded BEFORE the JNI on Windows
            preloadDiscordSdk = true;
        } else if (osName.contains("linux")) {
            osName = "linux";
            jniLibraryName = "lib" + JNI_LIBRARY_NAME + ".so";
            discordSdkName = DISCORD_LIBRARY_NAME + ".so";

            preloadDiscordSdk = false;
        } else if (osName.contains("mac os")) {
            osName = "macos";
            jniLibraryName = "lib" + JNI_LIBRARY_NAME + ".dylib";
            discordSdkName = DISCORD_LIBRARY_NAME + ".dylib";
        ...
        */
        ...
        initDiscordNative(discordSdkFile.getAbsolutePath());
        firstInitDone = true;
    }
