            ...
            params.registerEventHandler(new DiscordEventAdapter() {
                ...
                public void onRelationshipRefresh() {
                    ...
                    core.relationshipManager()
                            .filter(RelationshipManager.FRIEND_FILTER.and(RelationshipManager.ONLINE_FILTER));
                    int onlineFriendCount =
                            core.relationshipManager().count(); // get how many relationships match our filter
